...
public class TargetDataJSONWriter implements TargetDataWriter
{
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            jsonWriter.key(TARGET_KEY).value(targetData.getTarget());
            jsonWriter.key(SERVICE_KEY).value(targetData.getDatabase() + "(" + targetData.getHost() + ")");
            jsonWriter.key(COORDSYS_KEY).value(targetData.getCoordsys());
