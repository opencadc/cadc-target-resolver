...
public class TargetDataJSONWriterTest extends AbstractTargetDataWriterTest<TargetDataJSONWriter>
{
    @Test
    public void write() throws Exception
    {
        testSubject = new TargetDataJSONWriter();
        ...
        expectedJSON.put("time", TEST_TARGET_DATA.getQueryTime());
    ...
    public void writeError() throws Exception
    {
        ...
        final JSONObject expectedJSON = new JSONObject();
        expectedJSON.put("error", "BAD ERROR");
        expectedJSON.put("target", "m88");
        expectedJSON.put("service", "ned(myhost.com)");
        expectedJSON.put("coordsys", "ICRS");
        expectedJSON.put("ra", 88.0d);
    ...
    {
        return Format.JSON.name().toLowerCase();
    }
}
